...
To force non-interactive, always-restart-on-rude-edit behavior in unattended runs, keep `DOTNET_WATCH_RESTART_ON_RUDE_EDIT=1` and `dotnet watch --non-interactive`.
