...
public sealed class DataAccessArchitectureTests
{
    ...
    [
        "src/AgentsDashboard.ControlPlane/Features/ControlPlane/Services/WorkspaceImageStorageService.cs"
    ];
    ...
    {
        var matches = FindMatches(
            rootFolder: "src/AgentsDashboard.ControlPlane/Features/ControlPlane/Services",
            includeFile: path => path.EndsWith(".cs", StringComparison.Ordinal),
