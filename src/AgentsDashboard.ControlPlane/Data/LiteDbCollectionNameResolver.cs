...
public sealed class LiteDbCollectionNameResolver : ILiteDbCollectionNameResolver
{
    private static readonly IReadOnlyDictionary<Type, LiteDbCollectionDefinition> Definitions =
        new Dictionary<Type, LiteDbCollectionDefinition>
        {
            ...
            [typeof(AutomationDefinitionDocument)] = new("automation_definitions", nameof(AutomationDefinitionDocument.Id)),
            [typeof(AutomationExecutionDocument)] = new("automation_executions", nameof(AutomationExecutionDocument.Id)),
            ...
            [typeof(WorkflowExecutionDocument)] = new("workflow_executions", nameof(WorkflowExecutionDocument.Id)),
            ...
            [typeof(TaskTemplateDocument)] = new("task_templates", nameof(TaskTemplateDocument.Id)),
