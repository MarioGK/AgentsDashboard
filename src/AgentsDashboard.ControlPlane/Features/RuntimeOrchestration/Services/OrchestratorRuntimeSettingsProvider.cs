...
public sealed record OrchestratorRuntimeSettings(
    ...
    int RuntimeHeartbeatStaleSeconds,
    int RuntimeProbeFailureThreshold,
    int RuntimeRemediationCooldownSeconds,
    int RuntimeReadinessDegradeSeconds,
    int RuntimeReadinessFailureRatioPercent,
    ...
    IOptions<OrchestratorOptions> options) : IOrchestratorRuntimeSettingsProvider
{
    ...
    public async Task<OrchestratorRuntimeSettings> GetAsync(CancellationToken cancellationToken)
    {
        ...
        var resolved = new OrchestratorRuntimeSettings(
            ...
            RuntimeHeartbeatStaleSeconds: ClampPositive(orchestrator.RuntimeHeartbeatStaleSeconds, 10, 600, 60),
            RuntimeProbeFailureThreshold: ClampPositive(orchestrator.RuntimeProbeFailureThreshold, 1, 20, 2),
            RuntimeRemediationCooldownSeconds: ClampPositive(orchestrator.RuntimeRemediationCooldownSeconds, 5, 600, 30),
            RuntimeReadinessDegradeSeconds: ClampPositive(orchestrator.RuntimeReadinessDegradeSeconds, 10, 900, 45),
            RuntimeReadinessFailureRatioPercent: ClampPositive(orchestrator.RuntimeReadinessFailureRatioPercent, 1, 100, 30),
